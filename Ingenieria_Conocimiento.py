# Ingeniería del Conocimiento en la recomendación de películas

# Representación del conocimiento: Creación de una base de datos de películas y preferencias de usuario.
